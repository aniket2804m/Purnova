...
import Image from "../../../img/card/SEO optimization.jpg.jpeg";
      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            >
              Search Engine Optimization (SEO) helps your website rank higher on search engines, attract organic traffic, and generate quality leads. Our proven SEO strategies improve your online visibility, helping potential customers find your business when they need it most.
            </motion.p>
