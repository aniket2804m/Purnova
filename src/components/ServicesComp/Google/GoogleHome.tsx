...
import Image from "../../../img/card/google ads.jpg.jpeg";
      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            >
              Google Ads helps your business appear in front of people who are actively searching for your products or services. We create high-performing campaigns that drive qualified traffic, generate quality leads, and maximize your return on investment.
            </motion.p>
