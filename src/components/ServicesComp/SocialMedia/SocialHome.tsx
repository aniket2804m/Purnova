...
import Image from "../../../img/card/social media marketing.jpg.jpeg";
      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            >
              Social media is where your customers spend their time. We help you build a strong online presence with engaging content, targeted campaigns, and data-driven strategies that increase brand awareness, generate leads, and drive business growth.
            </motion.p>
