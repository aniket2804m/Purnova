...
import Image from "../../../img/card/web devlopment_.jpg.jpeg";
      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            >
              Your website is your digital storefront. We design and develop fast, responsive, and user-friendly websites that not only look professional but also help you attract visitors, generate leads, and increase sales.
            </motion.p>
